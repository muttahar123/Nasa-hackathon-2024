...
import pic1 from '../../assets/images/earth.png';
  ...
  const items = [
    {
      ...
      source: (
        <div className="gif">
          <img src={pic1} alt="" className="food-img" />
          <div className="text-gif">
            <p className="title"> Welcome to,
              <br />Climate Curators</p>
            <p className="subtitle">
              On this website we teach, warn,
              <br /> and  summon human being to a 
              <br />
              Struggle to contain harmful
              <br /> climate change. 
            </p>
          </div>
        </div>
